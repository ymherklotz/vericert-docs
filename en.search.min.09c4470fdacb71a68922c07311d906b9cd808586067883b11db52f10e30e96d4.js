...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aeff076d6e9b0b384920d3b30200e418907084a5cba80b98fd2d92b4f054a984.js',function(){input.required=false;search();});}
